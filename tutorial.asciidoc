...
* to create a new contacts.
    ...
    curl -v -X POST http://localhost:8080/jboss-contacts-angularjs/rest/contacts/ -d '{"firstName":"John","lastName":"Doe","email":"john.doe@mailinator.com","phoneNumber":"(212) 666-4444","birthDate":"1986-07-20"}'
