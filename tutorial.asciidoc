...
=== OpenShift
OpenShift is a Platform as a Service (PaaS) offered by Red Hat. It can host many types of applications, but for this coursework you will be using it to host Java EE 6 applications on JBoss EAP 6.1. OpenShift has a free teir of membership, which you will use for the coursework. 
