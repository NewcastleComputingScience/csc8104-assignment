...
TODO: Matt to add instructions for contacting him and getting a private repo.
...
* Unzip this to somewhere on your computer.
...
== Working with Git
You will be using Git in the coursework for regular checkpoint and backup of your code to GitHub. You will also use Git to update your application on OpenShift. This section will show you how to create a copy of the 'kitchensik-angularjs' example, ready fo you to extend in the coursework, and also how to push the code to GitHub and OpenShift.
