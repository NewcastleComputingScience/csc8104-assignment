...
== Working with Git
You will be using Git in the coursework for regular checkpoint and backup of your code to GitHub. You will also use Git to deploy new versions of your application to OpenShift. This section will show you how to create a copy of the 'kitchensik-angularjs' example, ready for you to extend in the coursework, and also how to push the code to GitHub and OpenShift.
...
*Dr Paul Robinson* is a Principal Software Engineer at Red Hat and a Visiting Research Fellow at the University. Paul leads the JBoss Developer team who execute on Red Hat's middleware developer programme (www.jboss.org). Paul has lead the Enterprise Distributed Computing coursework for over 10 years. He also supervises students for their Masters dissertation through industrial placements at Red Hat.
