...
In Part One you will build a simple service, hosted on a Platform as a Service Cloud. The service should be accessible through a RESTful Json api and accompanied by a selection of unit tests to demonstrate that it satisfies the provided requirements.

In Part Two you will create a more complex service, building upon the simple services built by yourself and your colleagues' services in Part One. This service should also be accompanied by unit tests and Json endpoints.

Parts Three and Four, if you have time to attempt them, involve modifying the frontend component of the base application to work with your new services. 
...
* *Angular.js*. This is a Javascript technology used to construct the web-interfaces to your application.
...
During Parts One & Two of the coursework you are not expected to have a functional frontend. You should instead test your API through Arquillian tests and one of the other methods presented to you during the tutorial (The command line and CURL, or Chrome and Postman).
...
=== API
Your API should provide endpoints to:
