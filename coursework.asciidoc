...
You should return to the frontend component of your application, written in Javascript using the link:https://angularjs.org/[Angular.js] framework. This code should currently be the same as that found in the original _kitchensink-angularjs_ application, unedited throughout the project so far.
